...
async function query(filterBy: Record<string, any> = {}): Promise<Recipe[]> {
...
function save(recipe: Recipe): Promise<Recipe> {
...
function addRecipe(name: string, imgUrl: string, username: string, userImgUrl: string, runs: number, likes: number): Recipe {
    return {
